from cv2 import cv2
import numpy as np 
#rom pyzbar.pyzbar import decode   #pyzbar helps in detection and decoding of the qrcode

import pickle,time
#import pyttsx3   #offline lib for tts  #for serial communication with arduino
